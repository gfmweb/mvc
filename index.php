...
// Автозагрузчик классов
    spl_autoload_register(function($className) {
        ...
        if(file_exists($pieces[0]."/".$pieces[1] .'.php')){ // проверка существования контроллера
            ...
            Header('Location: /404.php?er_title='.urlencode("УПС! Что-то пошло совсем не так").'&description='.urlencode("Нет такого раздела на этом сайте").'&action='.urlencode("<a href=\"http://".$_SERVER['SERVER_NAME']."\">Вернуться на сайт</a>"));
        }
    });
